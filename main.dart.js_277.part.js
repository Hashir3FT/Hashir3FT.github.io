...
oX(d,e,f){return C.eX5(d,e,f)},
eX5(d,e,f){var x=0,w=A.i(y.b),v,u=2,t,s,r,q,p,o,n,m,l
var $async$oX=A.j(function(g,h){if(g===1){t=h
x=u}while(true)switch(x){case 0:u=4
s=A.aN("GET",A.ad($.ah+"/Parties/GetCustomerPrevBalance?customerId="+d+"&orderDate="+e.m(0)+"&vOfficeID="+f,0,null))
x=7
return A.c(J.aO(s),$async$oX)
case 7:r=h
x=8
return A.c(B.E.ak(r.w),$async$oX)
case 8:q=h
...
var y={b:A.I("x<@>"),e:A.I("@")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_277",e:"endPart",h:b})})($__dart_deferred_initializers__,"i7INbJ58f8V/jScZ9JGj9+XbX60=");
...
bG6(d){var x,w,v,u,t,s=J.aK(d),r=s.i(d,"SectorID")
if(r==null)r=0
x=s.i(d,"SectorName")
if(x==null)x=""
w=s.i(d,"TownID")
...
t=s.i(d,"AreaID")
if(t==null)t=0
s=J.H(s.i(d,"Selected"),"False")
return new A.aG(r,w,v,u,t,x,!s)},
...
var y={g:B.I("e"),b:B.I("@")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_68",e:"endPart",h:b})})($__dart_deferred_initializers__,"rWEThdgNT0lt0tNmew0ANYOfCEw=");
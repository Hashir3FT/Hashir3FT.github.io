...
WJ(){var x=0,w=A.i(y.b),v,u=2,t,s,r,q,p,o,n,m,l
var $async$WJ=A.j(function(d,e){if(d===1){t=e
x=u}while(true)switch(x){case 0:u=4
s=A.aN("GET",A.ad($.ah+"//Security/GetNextUserId",0,null))
x=7
return A.c(J.aO(s),$async$WJ)
case 7:r=e
x=8
return A.c(B.E.ae(r.w),$async$WJ)
case 8:q=e
...
var y={b:A.H("x<@>"),e:A.H("@")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_126",e:"endPart",h:b})})($__dart_deferred_initializers__,"WMZDs4ZFky0fq8aHqtb90Xx1FBo=");
...
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,A,C,B={dq:function dq(d,e,f,g){var _=this
_.a=d
_.b=e
_.c=f
_.d=g},
tu(d){return B.eXg(d)},
eXg(d){var x=0,w=A.i(y.c),v,u=2,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e
var $async$tu=A.j(function(a0,a1){if(a0===1){t=a1
...
case 7:r=a1
x=8
return A.c(C.E.ag(r.w),$async$tu)
case 8:q=a1
...
if(h==null)h=""
g=j.i(k,"SubAccountNo")
if(g==null)g=""
k=j.i(k,"IsInventory")
if(k==null)k=!1
J.cb(o,new B.dq(i,h,g,k))}v=new A.x(o,1,null,null,y.c)
x=1
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_130",e:"endPart",h:b})})($__dart_deferred_initializers__,"4pMcU+LTOFrYqA0Bb2Pyzu99kqc=");
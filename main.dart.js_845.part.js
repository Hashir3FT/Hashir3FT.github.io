((a,b,c)=>{a[b]=a[b]||{}
a[b][c]=a[b][c]||[]
a[b][c].push({p:"main.dart.js_845",e:"beginPart"})})(self,"$__dart_deferred_initializers__","eventLog")
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,A,B,C,D={
Ak(){var x=0,w=A.i(y.c),v,u=2,t,s,r,q,p,o,n,m,l,k,j
var $async$Ak=A.j(function(d,e){if(d===1){t=e
x=u}while(true)switch(x){case 0:u=4
s=A.aN("GET",A.ad($.ah+"/Accounts/GetAccountTypes",0,null))
x=7
return A.c(J.aO(s),$async$Ak)
case 7:r=e
x=8
return A.c(B.E.ae(r.w),$async$Ak)
case 8:q=e
x=r.b===200?9:10
break
...
J.cd(o,C.tC(n))}v=new A.x(o,1,null,null,y.c)
x=1
break

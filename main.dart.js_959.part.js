((a,b,c)=>{a[b]=a[b]||{}
a[b][c]=a[b][c]||[]
a[b][c].push({p:"main.dart.js_959",e:"beginPart"})})(self,"$__dart_deferred_initializers__","eventLog")
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,B,C,H,I,E,K,L,M,D,F,A={amH:function amH(d){this.a=d},Dh:function Dh(){},aJN:function aJN(){},mf:function mf(){},
eyR(d,e,f,g){var x=$.ap(),w=e==null?new D.aAF().KY():e
return new A.pH(new B.dj(d,x,g.k("dj<0?>")),$,!1,!1,new D.rl(y._),new D.rl(y.J),x,B.a6(y.N,y.A),w,f,g.k("pH<0>"))},
pH:function pH(d,e,f,g,h,i,j,k,l,m,n){var _=this
_.fr=d
_.ahm$=e
_.a_X$=f
_.ahn$=g
...
case 7:r=a2
x=8
return B.c(C.E.ag(r.w),$async$agc)
case 8:q=a2
...
J.cb(o,new A.mq(i,h,g,f,!k))}v=new B.x(o,1,null,null,y.Z)
x=1
...
case 7:p=g
x=8
return B.c(C.E.ag(p.w),$async$agq)
case 8:o=g
...
$idY:1}
A.Dh.prototype={
gp(d){return A.mf.prototype.gky.call(this,0)},
gky(d){return A.mf.prototype.gky.call(this,0)},
gmr(){return B.dN(A.mf.prototype.gmr.call(this),!0,y.M)},
gaGc(d){var x
...
x=this.z.gwi()
return new B.hL(x,B.a_(x).k("hL<1>"))},
gaKR(){return B.a5(D.f1f(this,"The insertNodes stream is not allowedfor the ListenableNode. The index based operations like 'insert' are not implemented in ListenableNode"))},
X(d,e){this.a6z(0,e)
this.N0()
this.Xn(new D.pp(B.dN([e],!0,y.E),y.x))},
R(d,e){this.bbP(0,e)
this.N0()
this.azM(new D.we(B.dN([e],!0,y.E),y.b))},
fd(d,e){return this.a6A(0,e)},
i(d,e){return this.a6A(0,e)},
v(){this.y.bl(0)
this.z.bl(0)
this.jJ()},
N0(){this.aQ()
var x=this.x
if(x!=null)x.N0()},
Xn(d){if(this.x==null)this.y.gwi().X(0,d)
else A.mf.prototype.gky.call(this,0).Xn(d)},
azM(d){if(this.x==null)this.z.gwi().X(0,d)
else A.mf.prototype.gky.call(this,0).azM(d)},
$iaS:1,
gar(d){return this.x}}
A.aJN.prototype={}
A.mf.prototype={
gky(d){return y.A.a(D.fp.prototype.gky.call(this,0))},
gmr(){var x=this.c.gbk(0)
...
e.x=this
x.h(0,w,e)},
R(d,e){this.c.R(0,e.d)},
i(d,e){return this.a6A(0,e)},
fd(d,e){var x,w,v,u,t,s
...
Lm(){var x=0,w=B.i(y.D),v,u=this,t,s,r
var $async$Lm=B.j(function(d,e){if(d===1)return B.e(e,w)
while(true)switch(x){case 0:s=B.b([],y.u)
r=u.e.a
r.toString
x=3
return B.c(A.agc(r),$async$Lm)
case 3:t=e
if(t.c!==0){r=t.a
r.toString
s=r}v=s
...
x=2
return B.c(E.vl(" AND Isnull(IsAdministrator,0)=0"),$async$K)
case 2:u=e
if(u.c!==0){t=u.a
t.toString
v.e=J.A(t,0)}v.j(new A.cGT(v))
v.w=v.Lm()
return B.f(null,w)}})
return B.h($async$K,w)},
a3(){this.ab()
this.K()},
I(d){var x=this,w=null,v=B.F(d,w,y.w).w.a.a>1200?20:10,u=B.aj(x.bXi(),1),t=x.r?C.x:new L.D(new A.cGP(x,d),M.aa,"Save",w,w),s=y.p
t=B.l(B.b([C.t,u,C.t,t],s),C.c,w,C.d,C.b,w)
if(x.f)u=B.bR(B.d0("assets/animations/loading.json",w,w),w,w)
else{u=x.w
u===$&&B.a()
u=B.ef(new A.cGQ(x),u,y.D)}return B.bh(w,new B.ar(new B.aJ(v,15,v,15),B.aL(B.K(B.b([C.u,G.aJM,C.u,C.i,t,u],s),C.c,w,C.d,C.b,C.l),w,C.y,w,w,w,w,C.C),w),w,w,w,w)},
aG1(d,e,f){var x,w,v,u,t,s,r,q,p,o,n,m=J.hG(e,new A.cGC(f)),l=B.a4(m,!0,m.$ti.k("a0.E"))
for(m=l.length,x=y.E,w=y.x,v=y.O,u=d.y,t=u.$ti.k("qT<1>"),s=0;s<m;++s){r=l[s]
q=r.a
...
o=d.x
if(o!=null)o.N0()
o=new D.pp(B.dN([p],!0,x),w)
if(d.x==null){n=u.a
if(n==null)n=u.a=new B.qT(null,null,t)
n.X(0,o)}else A.mf.prototype.gky.call(d,0).Xn(o)
this.aG1(p,e,q)}},
aHi(d,e){var x,w,v,u,t
for(x=B.dN(A.mf.prototype.gmr.call(d),!0,y.M),w=x.length,v=y.v,u=0;u<w;++u){d=v.a(x[u])
t=d.fr.a
if(t!=null)t.e=e
this.aHi(d,e)}this.j(new A.cGR())},
ao_(d){var x,w,v,u,t,s
for(x=B.dN(A.mf.prototype.gmr.call(d),!0,y.M),w=x.length,v=y.v,u=0;u<w;++u){d=v.a(x[u])
t=d.fr.a
s=t.e
s.toString
if(s)this.y.push(t)
this.ao_(d)}}}
var z=a.updateTypes(["L(mq)","~()","~(fp)","r(v,cc<q<mq>>)","~(Gg<mq,pH<mq>>)","yY(v,ig<@>)","eQ(v,pH<mq>)"])
A.cGW.prototype={
...
aVG(d){var x=0,w=B.i(y.L),v,u
var $async$$1=B.j(function(e,f){if(e===1)return B.e(f,w)
while(true)switch(x){case 0:x=3
return B.c(E.vl(" AND Isnull(IsAdministrator,0)=0"),$async$$1)
case 3:u=f.a
v=u==null?B.b([],y.P):u
x=1
break
...
aVF(d){var x=0,w=B.i(y.a),v=this,u
var $async$$1=B.j(function(e,f){if(e===1)return B.e(f,w)
...
q.y=B.b([],y.u)
t=q.x
if(t!=null)C.f.b_(t.$ti.y[1].a(t.a.a).gmr(),new A.cGK(q))
q.j(new A.cGL(q))
t=q.y
s=q.e.a
s.toString
...
if(x!=null)return B.m("Error: "+J.u(x),i,i,i,i,i,i,i,i)}x=e.b
x.toString
w=y.O
v=A.eyR(i,i,i,w)
u=J.hG(x,new A.cGG())
...
l=v.x
if(l!=null)l.N0()
l=new D.pp(B.dN([j],!0,s),r)
if(v.x==null){k=p.a
if(k==null)k=p.a=new B.qT(i,i,o)
k.X(0,l)}else A.mf.prototype.gky.call(v,0).Xn(l)}return D.eKU(new A.cGH(q),F.Ei,new A.cGI(),!0,F.FX,i,i,new A.cGJ(q),i,i,i,i,!1,!0,v,w,y.v)},
$S:z+3}
A.cGG.prototype={
$1(d){return d.c===""},
$S:z+0}
...
$S:z+4}
A.cGI.prototype={
$2(d,e){return D.eIo(C.z,C.oB,C.bk,e)},
$S:z+5}
A.cGH.prototype={
...
return new B.ar(C.vR,B.hK(!1,x,x,x,!0,x,x,x,!1,x,t,x,x,x,x,!1,x,x,x,x,x,B.m(B.p(u?x:v.b),x,x,x,x,x,x,x,x),x,x),x)},
$S:52}
A.cGE.prototype={
...
x.a6z=x.X
x.bbP=x.R
x.a6A=x.fd})();(function installTearOffs(){var x=a._instance_0u
x(A.Dh.prototype,"giV","v",1)})();(function inheritance(){var x=a.mixin,w=a.inheritMany,v=a.inherit
w(B.ag,[A.amH,A.mq])
v(A.mf,D.fp)
v(A.aJN,A.mf)
v(A.Dh,A.aJN)
...
x(A.aJN,B.bw)
x(A.acU,D.ig)})()
B.b6(b.typeUniverse,JSON.parse('{"amH":{"dY":[]},"Dh":{"mf":[],"bw":[],"fp":[],"aS":[]},"mf":{"fp":[]},"pH":{"Dh":[],"ig":["1"],"mf":[],"bw":[],"fp":[],"aS":[]},"Bh":{"G":[],"r":[]},"aEj":{"Q":["Bh"]}}'))
B.Ur(b.typeUniverse,JSON.parse('{"acU":1}'))
var y=(function rtii(){var x=B.I
return{Z:x("x<q<mq>>"),X:x("x<@>"),_:x("rl<pp<fp>>"),J:x("rl<we<fp>>"),E:x("fp"),P:x("n<eD>"),u:x("n<mq>"),p:x("n<r>"),S:x("y<ac<eD>>"),L:x("q<eD>"),D:x("q<mq>"),M:x("Dh"),w:x("ba"),A:x("mf"),x:x("pp<fp>"),b:x("we<fp>"),a:x("H"),N:x("d"),v:x("pH<mq>"),q:x("eD"),O:x("mq"),z:x("@"),H:x("~")}})();(function constants(){G.aJM=new H.bj("User Tasks",null,"system",null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_959",e:"endPart",h:b})})($__dart_deferred_initializers__,"Nbp7GKPcDz/myi/5KEPxDR83VXc=");
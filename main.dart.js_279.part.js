...
oW(d,e,f){return C.eXJ(d,e,f)},
eXJ(d,e,f){var x=0,w=A.i(y.b),v,u=2,t,s,r,q,p,o,n,m,l
var $async$oW=A.j(function(g,h){if(g===1){t=h
x=u}while(true)switch(x){case 0:u=4
s=A.aN("GET",A.ad($.ah+"/Parties/GetCustomerPrevBalance?customerId="+d+"&orderDate="+e.m(0)+"&vOfficeID="+f,0,null))
x=7
return A.c(J.aO(s),$async$oW)
case 7:r=h
x=8
return A.c(B.E.ai(r.w),$async$oW)
case 8:q=h
...
var y={b:A.I("x<@>"),e:A.I("@")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_279",e:"endPart",h:b})})($__dart_deferred_initializers__,"2tOBYz9I90nDtNZ+fYpdvcdqPZI=");
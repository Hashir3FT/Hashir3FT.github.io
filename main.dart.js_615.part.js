((a,b,c)=>{a[b]=a[b]||{}
a[b][c]=a[b][c]||[]
a[b][c].push({p:"main.dart.js_615",e:"beginPart"})})(self,"$__dart_deferred_initializers__","eventLog")
...
if(l==null)l=null
else{l=J.cw(l,new B.bPi(),y.U)
l=A.a4(l,!0,l.$ti.k("aA.E"))}k=m.a(k.i(d,"ListStore"))
if(k==null)k=null
else{k=J.cw(k,new B.bPj(),y.V)
k=A.a4(k,!0,k.$ti.k("aA.E"))}return new I.pM(q,j,s,x,p,w,v,u,t,r,o,n,l,k)},
feK(d){var x
if(y.g.b(d)&&d!=null){x=J.cw(d,new B.bPk(),y.G)
...
VY(d,e,f,g,h){return B.eXl(d,e,f,g,h)},
eXl(d,e,f,g,h){var x=0,w=A.i(y.M),v,u=2,t,s,r,q,p,o,n,m,l,k,j
var $async$VY=A.j(function(i,a0){if(i===1){t=a0
...
case 7:r=a0
x=8
return A.c(C.E.ag(r.w),$async$VY)
case 8:q=a0
x=r.b===200?9:10
break
case 9:l=C.k.C(0,q,null)
x=11
return A.c(y._.b(l)?l:A.bT(l,y.z),$async$VY)
case 11:p=a0
o=A.b([],y.d)
for(l=J.aZ(J.A(p,"data"));l.N();){n=l.ga1(l)
J.cb(o,B.eLh(n))}v=new A.x(o,1,null,null,y.M)
x=1
break
...
case 7:r=f
x=8
return A.c(C.E.ag(r.w),$async$N4)
case 8:q=f
x=r.b===200?9:10
break
...
VB(d,e,f,g,h){return B.eWE(d,e,!1,!1,h)},
eWE(d,e,f,g,h){var x=0,w=A.i(y.X),v,u=2,t,s,r,q,p,o,n,m,l,k,j,i
var $async$VB=A.j(function(a0,a1){if(a0===1){t=a1
x=u}while(true)switch(x){case 0:u=4
...
case 7:p=a1
x=8
return A.c(C.E.ag(p.w),$async$VB)
case 8:o=a1
x=p.b===200?9:10
break
...
k=y.z
x=11
return A.c(y._.b(l)?l:A.bT(l,k),$async$VB)
case 11:n=a1
l=A.X(n,k)
v=l
x=1
...
B.aSr.prototype={
W5(){var x=0,w=A.i(y.Z),v,u=this,t,s,r,q,p,o,n
var $async$W5=A.j(function(d,e){if(d===1)return A.e(e,w)
...
r=r==null?null:r.a
x=3
return A.c(B.VY(n,t,o,r==null?0:r,s),$async$W5)
case 3:q=e
p=A.b([],y.d)
if(q.c!==0){o=q.a
o.toString
...
au(){return W.af(new B.epq(),new B.epr(),this.f,null,null,!0,new B.eps(),null,"Offices",!0,new B.ept(this),"Search with id and name",this.w,y.L)},
a3(){var x,w=this
w.ab()
x=w.c
x.toString
...
w=A.m("Wastage Invoice Screen",u,u,u,u,$.o().l(18,C.v),u,u,u)
w=A.bO(A.b([A.bU(u,!1,u,u,u,u,u,u,u,u,M.fm,u,u,u,u,new B.epl(v,d),u,u,u,u,u,u,u)],y.p),!0,u,u,u,u,x,w,u,u)
x=w}else x=u
t=A.F(d,u,t).w.a.a>1200?20:10
w=y.p
return A.bh(x,new A.ar(new A.aJ(t,15,t,15),A.K(A.b([new A.bp(A.K(A.b([C.u,G.aJc,C.u,A.l(A.b([new A.k(3,C.e,F.a1(v.y,u,u,u,"From Date",!0,new B.epm(v)),u),new A.k(3,C.e,F.a1(v.z,u,u,u,"To Date",u,new B.epn(v)),u),C.t,new A.k(8,C.e,v.au(),u)],w),C.c,u,C.d,C.b,u),C.u],w),C.c,u,C.d,C.b,C.l),u,C.cC,u),new X.D(new B.epo(d),C.aB,"Add Invoice",u,u),C.u,A.ef(new B.epp(v),v.W5(),y.Z)],w),C.Z,u,C.d,C.b,C.l),u),u,u,u,u)}}
B.aAZ.prototype={
bi5(d,e){var x=J.cw(e,new B.bPh(),y.n)
this.go=A.a4(x,!0,x.$ti.k("aA.E"))},
gdl(d){return this.go},
fq(d){var x=d.a,w=A.aq(x).k("ak<1,r>")
return new D.dV(null,A.a4(new A.ak(x,new B.bPg(this,d,new R.eO(this.fy)),w),!0,w.k("aA.E")))}}
var z=a.updateTypes(["zG(@)","zH(@)","nG(@)","t<q<w>>(d)","d(w)","H(w?)","z(v,w?)","au(pM)","c_(M<@>)","L(M<@>)"])
B.bPi.prototype={
...
return new B.zG(u,w,s,q,x.i(d,"Quantity"),t,v,r,p,x.i(d,"StoreID"))},
$S:z+0}
B.bPj.prototype={
$1(d){var x=J.aI(d),w=x.i(d,"StoreID"),v=x.i(d,"InvoiceId"),u=x.i(d,"QtyP"),t=x.i(d,"QtyL")
return new B.zH(w,x.i(d,"ProductID"),x.i(d,"PackingID"),u,t,v)},
$S:z+1}
B.bPk.prototype={
...
v=u==null?v.k2:u
A.dW(x,v,x,new B.epj(this.a),x,x,w,x,!0,!0,!1,x,x,!1,!1,y.z)},
$S:0}
B.epj.prototype={
$1(d){var x=null,w=this.a,v=y.p
return new A.ar(new A.aJ(15,10,15,A.F(d,x,y.w).w.f.d),A.K(A.b([G.aVd,C.u,A.l(A.b([new A.k(3,C.e,F.a1(w.y,x,x,x,"From Date",!0,new B.epf(w)),x),new A.k(3,C.e,F.a1(w.z,x,x,x,"To Date",x,new B.epg(w)),x)],v),C.c,x,C.d,C.b,x),C.i,w.au(),C.u],v),C.c,x,C.d,C.a_,C.l),x)},
$S:30}
B.epf.prototype={
$1(d){var x=this.a
x.j(new B.epe(x,d))},
...
if(x!=null)return A.bR(A.m(J.u(x),s,s,s,s,s,s,s,s),s,s)}w=e.b
x=B.eLg(d,w==null?A.b([],y.d):w)
this.a.r=x
v=y.w
u=D.aH(!0,!0,!0,"id",E.ag,A.T(C.z,A.m(A.F(d,s,v).w.a.a>1200?"Wastage ID":"ID",s,s,s,s,s,s,s,s),C.r,s,s,s,s,s,s,s,C.X,s,s,s),!0,0/0)
t=D.aH(!0,!0,!0,"date",E.a4,A.T(C.z,T.es,C.r,s,s,s,s,s,s,s,C.X,s,s,s),!0,0/0)
v=A.F(d,s,v).w.a.a>1200?E.as:E.a4
return A.aj(O.hm(!0,!0,A.b([u,t,D.aH(!0,!0,!0,"amount",v,A.T(C.z,V.ep,C.r,s,s,s,s,s,s,s,C.X,s,s,s),!0,0/0),D.aH(!0,!1,!1,"actions",E.ao,A.T(C.ah,N.bE,C.r,s,s,s,s,s,s,s,C.X,s,s,s),!0,155)],y.t),s,s,s,!1,x),1)},
$S:1091}
B.bPh.prototype={
$1(d){var x=d.a,w=y.F,v=d.b
v.toString
v=U.e5(v)
return new D.au(A.b([new D.M("id",x,w),new D.M("date",A.aG("MM/dd/yyyy",null).a5(v),w),new D.M("amount",d.z,w),Q.dT],y.O))},
$S:z+7}
B.bPg.prototype={
$1(d){var x,w,v,u,t=null
if(d.a==="actions"){x=this.b
w=C.f.bI(x.a,new B.bPd()).b
v=this.a
u=this.c
return A.T(C.z,new S.eM(new B.bPe(v,u,w),new B.bPf(v,u,w,x),t,t,v.fy,t),C.r,t,t,t,t,t,t,t,C.P,t,t,t)}else return A.T(C.z,A.m(J.u(d.b),t,C.o,t,t,t,t,t,t),C.r,t,t,t,t,t,t,t,C.P,t,t,t)},
$S:z+8}
B.bPd.prototype={
$1(d){return d.a==="id"},
$S:z+9}
...
B.bPb.prototype={
$1(d){var x=this
return A.U("Do you want to delete this invoice",null,new B.bPa(x.a,d,x.b,x.c,x.d),null,"Are You Sure",C.aX)},
$S:1}
B.bPa.prototype={
...
q.toString
x=7
return A.c(B.VB(q,s,!1,!1,$.cx().a),$async$$0)
case 7:p=e
t=t.a
...
t.fC()
if(o.e==null){x=1
break}A.O(null,null,!0,null,new B.bP7(p),o,null,!0,y.z)}else{A.S(t,!0).a7("dialog")
if(o.e==null){x=1
...
return{M:x("x<q<pM>>"),S:x("x<pM>"),X:x("x<@>"),F:x("M<@>"),n:x("au"),_:x("t<@>"),O:x("n<M<@>>"),K:x("n<au>"),t:x("n<dE>"),R:x("n<dJ>"),m:x("n<nG>"),d:x("n<pM>"),p:x("n<r>"),E:x("n<~({propertyName:d?,recalculateRowHeight:L,rowColumnIndex:aB?})>"),f:x("n<~({rowColumnIndex:aB?})>"),l:x("y<ac<w>>"),T:x("q<du>"),e:x("q<w>"),Z:x("q<pM>"),w:x("ba"),P:x("H"),I:x("av<~({propertyName:d?,recalculateRowHeight:L,rowColumnIndex:aB?})>"),Y:x("av<~({rowColumnIndex:aB?})>"),L:x("w"),N:x("d"),U:x("zG"),G:x("nG"),Q:x("pM"),V:x("zH"),z:x("@"),g:x("q<@>?"),H:x("~")}})();(function constants(){G.aJc=new H.bj("Wastage Invoice Screen",null,"stock",null)
G.aVd=new A.z("Wastage Invoice",null,L.jX,null,null,null,null,null,null,null,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_615",e:"endPart",h:b})})($__dart_deferred_initializers__,"F5xjv1srdfUwmCnV+z9Rm0hl+ew=");